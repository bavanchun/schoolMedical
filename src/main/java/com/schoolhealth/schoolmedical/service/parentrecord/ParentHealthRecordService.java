...
public interface ParentHealthRecordService {
     ...
     */
    ParentHealthRecordResponse createParentHealthRecord(ParentHealthRecordRequest request);
     ...
     */
    ParentHealthRecordResponse updateParentHealthRecord(Long id, ParentHealthRecordRequest request);

    /**
     * Soft delete a record by id.
     */
    void deleteParentHealthRecord(Long id);
}
